...
class PrologParser ( Parser ):
    ...
    class Binary_operatorContext(TermContext):
        ...
        def operator_(self):
            return self.getTypedRuleContext(PrologParser.Operator_Context,0)
    ...
    class Operator_Context(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return PrologParser.RULE_operator_
    ...
    def operator_(self):
        ...
        localctx = PrologParser.Operator_Context(self, self._ctx, self.state)
